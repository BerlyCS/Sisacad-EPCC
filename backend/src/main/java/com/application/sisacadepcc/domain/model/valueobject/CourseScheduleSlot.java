...
public class CourseScheduleSlot {
    ...
    public CourseScheduleSlot() {
    }

    public CourseScheduleSlot(String classroomName, String dayOfWeek, String startTime, String endTime) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CourseScheduleSlot that)) return false;
